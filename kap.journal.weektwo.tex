...
About ahlfway through the distance thunderstorm clouds rouse above the horizon.
They reached us just as we returned to the car park.
Yes, we got \emph{rained upon}.
In the \emph{desert}.
And ther were still people up on the hike.
...
\emph{Achievement unlocked}\\
"Dry Heat My Ass"\\
\multicolumn{1}{||p{0.8\textwidth}||}{\footnotesize - Get drenched by rain in the Red Centre} \\
\end{tabular}
\end{center}
...
We now see why there are signs warning about \emph{floodways}-
...
We climbed a few stone slopes, bested ridgety steps and ducked under low vegetation to the second outlook.
...
Second thing we noticed: The path we trailed back on doubles as a natural rainpipe for both the cliff faces we found ourselves in between.
...
And we encountreed some souls that were even more adventurous as they were hiking \emph{up} the path during the rain.
We reached the car park even before the do-not-get-wets came back from thour excursion.
...
Next thing I habe been advised to log is the horribly inaccurate fuel gauge of our current rental car.
...
The one we encountered seems untypically drinking-proofed and had a lot of games, tricks and whatnot ready to get us drunk and paying for her drinks.
...
When the rain clouds are hising the sun, sunrise is still not that impressive.
...
A natural encyclopedia that yoou need to learn how to read.
...
We checked out teh same car as we had in the Red Center, a KIA Grand Carnival\ldots{}
...
So we returned to the hotel and bought a 24h access apckage.
...
\emph{Achievement unlocked}\\
"AdHoc Commissioning"\\
\multicolumn{1}{||p{0.8\textwidth}||}{\footnotesize - Set up your own wireless hotspot using the hotel's wired access} \\
\end{tabular}
\end{center}
...
Then we touriststrolled through the rain forest on concrete-covered paths.

\paragraph{29. October 15:50; Scenic Railroad}
Rolling along a railway track which is about a century old.
We get treatedto a view of Barron Falls and Robb's Monument, from which at one point "the Italian flag was flown, to show their courage".
...
Somehow the reception does not seem very efficient.

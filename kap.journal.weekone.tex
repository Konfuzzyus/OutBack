...
Peculiarity: Part of the walkway through the cave doubled as road.
...
Picked up a sandwich, a pastie, two pies, two hamburgers and a chicken salad.
...
We walked past a flickering TV screen, some kids rustled around.
...
\texttt{>>> 600km TRAVELED BY CAR <<<}

\paragraph{18. October, 9:40; Highway to Cooma}
This is cow country, the secret cow level, holy cowtopia, the great grazing grounds,
...
Compared to the rolling grasslands we pass now, where the cattle grounds go on until they meet the horizon,
...
We now have even seen \emph{live} kangaroos and emus and have made our way over the Snowy Mountain Road.

A quick stop at the lookout shows a lot of forested mountainside.
...
Stopped at Australia's highest up village. Finding the café closes it's kitchen at 1400.
We settled for Cup Noodles - well - some of us did.
The others maintain their sugar levels with sweets and candy bars.

We skipped photographing the town sign and I found my pen.

\texttt{>>> 875km TRAVELED BY CAR <<<}
...
Driving, driving, driving - on roadkill less roads.
Passing meadows, fences, forests, sheep, cows, cars, horses, birds, traffic signs and concealed entrances.

Trying to point out to the others what I have dubbed \emph{Sheep Launch Pads}: Small ramps that are directed outwards from a corral and lead to virtually nowhere.
...
The whole forest looks like green cotton candy sticks.
...
And the front grill is a war zone.
...
After six attempts which ended with the tablet pc crashing and losing the play list, we finally found an app that does not crash, hang, stop playing when the display turns off or just drops the play list randomly.
So we now have reliable music in the background without having to rely on Aussie radio, which is - according to everyone in the car - just plain horrible.
...
\paragraph{20. October, 10:35; Along the railroad tracks}
...
Either this keeps wildlife from wandering onto the road (with mediocre success) or it keeps cattle from walking more than a few miles in a straight line.
...
They are for loading and unloading livestock into transporters\ldots{}
duh\ldots{}
...
Why did we end up in Weird-Names-Country? We are passing Baw Baw Mountain, Drouin, Darnum, Robin Hood, Service Center Bay - now wait, that is no town - Dadenoug and Labertouche.
...
Traffic gets heavier as we close on target.
...
We arrived in hook-turn-notorious Melbourne city. 
A hook turn seems to be when you try to take a right turn from the lane on the extreme left.
And it looks like certain suicide when performed.

We split up for the city exploration since The Preceptress had to organize her flight to New Zealand.
...
The city itself reminds me of San Francisco or even Zurich, except this one feels more like a police state than both of the others.
In the evening we even saw a police car with a supposed sobering cell attached.
Scary prospects for drunkards.

went to a pub \emph{The Local Taphouse} to meet The Preceptress's acquaintances.
...
The district the pub was in left an\ldots{} interesting impression. It looked a bit shabby, the buildings were mostly in a desolate state from the outside, yet nice from the inside.
...
We headed out for Chinatown, which was somewhat disappointing, then went onward to Saint Patrick's Cathedral.
Being archbishop of Melbourne seemed to be a dangerous job. Of the seven they have had so far, five already died and one seems to have quit the job before it could take the better of him.
...
We missed one because we decided to have a look at graffiti lane.
There one of the fundamental truths about mankind was displayed.
Even when graffiti is legal, artfully created pictures will still be scribbled over by idiots only capable of reliably misspelling their names.
...
The viewing facility was named Sky deck 88 and was reasonably high up.
Still too high up for me to feel comfortable on the terrace when the wind blew.
The view was nice though.
Lots of lighting and little cars moving in the streets and ways of slipping and crashing through a window and plummeting to \ldots{}
...
\multicolumn{1}{||p{0.8\textwidth}||}{\footnotesize - Witness Wall Street protesters protesting}\\
\multicolumn{1}{||p{0.8\textwidth}||}{\footnotesize - Witness Wall Street protesters being cleared away by the police}\\
\end{tabular}
\end{center}
...
Bickering an moaning colors the conversations.
...
We planned for some sightseeing on today's stretch of road.
...
The weather is still ghastly but at least it stopped raining.
The surfers seem unimpressed, straddling the waves despite the cold.
Defying the rocky ground and the chilling winds.
...
\paragraph{22. October, 14:35; Lorne Visitor Center}
Lunch today was a picnic, literally.
We were under siege by seagulls during the whole meal and then cacadoos joined in.
We got out while we could, being spared bird poo and beak attacks.
...
We see gray furry butts in the sky.
...
Seagulls screech overhead, circling the lone rock pillars guarding their lonely post in the spray.
We watch and feel the soft ocean breeze whiffing across the shrubbery.
Below, the sea is sifting sand from the shore, patiently scrubbing land from the country, claiming one coastal spire after the other in an endless dance of erosion.
...
There was also a teeny problem while driving to and fro the pizza joint.
...
This in turn led to the system to disallow any car with our key entering the park.
So our car ended up \emph{outside} the park with the system still believing it to be \emph{inside} the park.
